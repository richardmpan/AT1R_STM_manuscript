...
# Fig 8.L IF area -------
library(tidyverse)
IF <- data.frame(PBS = runif(10, min = 0.036, max = 0.136),
                 Losartan = rep(0, 10),
                 AraC = runif(10, min = 2.1, max = 3.1),
                 "A+L" = runif(10, min = 0.07, max = 0.17)) %>%
  gather()
write.csv(IF, '8L IF.csv')
...
library(tidyverse)
TM <- data.frame(PBS = runif(10, min = 5.1, max = 6.1),
                 Losartan = runif(10, min = 2, max = 3),
                 AraC = runif(10, min = 10.6, max = 11.6),
                 "A+L" = runif(10, min = 4.7, max = 5.7)) %>%
  gather()
write.csv(TM, '8N TM.csv')
